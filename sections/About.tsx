...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <TypingText title="| About Metaversus" textStyles="text-center text-white" />
      <motion.p
        variants={fadeIn('up', 'tween', 0.2, 1)}
        className="mt-2 text-center text-[20px] font-normal text-secondary-white sm:text-[32px]"
      >
      ...
      <motion.img
        ...
        src="./arrow-down.svg"
        alt="arrow down"
        className="mt-7 h-[28px] w-[18px] object-contain"
      />
    </motion.div>
  </section>
);
